...
var t, r = (t = require("axios")) && "object" == typeof t && "default" in t ? t.
default:
  t;
  function e() {
    e = function() {
    ...
    function h(t, r, e, n) {
      var o = Object.create((r && r.prototype instanceof l ? r: l).prototype),
      i = new _(n || []);
    ...
    g = y && y(y(j([])));
    g && g !== r && n.call(g, i) && (d = g);
    var m = v.prototype = l.prototype = Object.create(d);
    function w(t) { ["next", "throw", "return"].forEach((function(r) {
        u(t, r, (function(t) {
    ...
    function L(t, r) {
      ...
      if (void 0 === e) {
        if (r.delegate = null, "throw" === r.method) {
          if (t.iterator.
          return && (r.method = "return", r.arg = void 0, L(t, r), "throw" === r.method)) return s;
          r.method = "throw",
      ...
      if ("throw" === n.type) return r.method = "throw",
      r.arg = n.arg,
      r.delegate = null,
      s;
      var o = n.arg;
    ...
    _.prototype = {
      constructor: _,
      reset: function(t) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(E), !t) for (var r in this)"t" === r.charAt(0) && n.call(this, r) && !isNaN( + r.slice(1)) && (this[r] = void 0)
      },
      stop: function() {
        this.done = !0;
  ...
  exports.create_payement = function() {
    var t = o(e().mark((function t(n) {
      ...
      return e().wrap((function(t) {
        ...
        case 0:
          ...
          t.prev = 1,
          t.next = 4,
          r.post("http://epay.chargily.com.dz/api/invoice", n, o);
        case 4:
          // window.location = t.sent.data.checkout_url,
          return t.sent.data.checkout_url,
          t.next = 13;
          break;
        case 10:
          t.prev = 10,
